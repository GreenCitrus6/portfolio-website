...
function SocialLink( {snsName} ) {
    let githubIcon = <svg className="w-6 h-6 text-gray-50 dark:text-white" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    let linkedinIcon = <svg className="w-6 h-6 text-gray-50 dark:text-white" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15">
